          ...
          <div className="parte-direita">
            <div className="conteudo">
              ...
              <div className="descricao">
                <p>
                  Fundada em 2012 por um pequeno grupo de voluntários locais, a Cão sem Dono é uma organização dedicada a resgatar, tratar e realocar cães em situação de abandono e vulnerabilidade. Nossa missão é promover bem‑estar animal por meio de resgate humanitário, atendimento veterinário, castração em massa e programas de adoção responsável.<br /><br />

                  Desde a criação, já resgatamos mais de 4.200 animais e, em média, promovemos 350 adoções por ano. Mantemos um abrigo com capacidade para 180 cães e uma rede de mais de 120 voluntários que atuam em resgates emergenciais, transporte, acolhimento temporário (lar de passagem) e divulgação para adoção.<br /><br />
              ...
              <div className="meio-contato">
                <a className="href" href="https://www.caosemdono.com.br/" >Website Cão sem Dono</a>
