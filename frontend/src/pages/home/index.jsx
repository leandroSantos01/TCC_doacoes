    ...
    <div>
      ...
      <section>
        <div className="carousel-container">
          <h1 style={{ textShadow: " -1px 1px 1px rgb(129, 129, 224)" }}>
            Para quem doar
          </h1>
      ...
      <section className="secao_sobre">
        <div className="pag_sobre">
          <h1>
            Sobre <strong>DonNet</strong>
          </h1>
          <p>
            Esta Central de Doações foi concebida e desenvolvida como o
            principal produto do nosso Trabalho de Conclusão de Curso,
            integralmente realizado no contexto do curso de Informatica do
            Instituto Nossa Senhora de Fatima. A gênese deste projeto reside na
            identificação e criação de ongs. Nosso principal objetivo é
            estabelecer uma ponte digital robusta e transparente, que não apenas
            simplifique o processo de contribuição para o doador, mas também
            garanta que os recursos cheguem de forma eficaz e segura às
            entidades e indivíduos necessitados. Ao longo desta pesquisa e
            desenvolvimento, aplicamos metodologias de Engenharia de Software
            para construir uma solução escalável e sustentável. Esta central é,
            portanto, a materialização da nossa dedicação acadêmica, servindo
            como um modelo prático de como a inovação tecnológica pode
            impulsionar a responsabilidade social corporativa e comunitária.
          </p>
          ...
          <div className="blocos-info">
            <div className="bloco">
              ...
              <h3>Missão</h3>
              <p>
                Promover o bem-estar e o desenvolvimento social, conectando e
                mobilizando pessoas e instituições em uma rede de solidariedade
            ...
            <div className="bloco">
              ...
              <h3>Visão</h3>
              <p>
                Ser referência nacional em conexões solidárias, inspirando
                confiança, engajamento e transformação através do uso consciente
                da tecnologia.
              </p>
            </div>
